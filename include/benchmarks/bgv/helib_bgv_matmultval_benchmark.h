...
{
public:
    HEBERROR_DECLARE_CLASS_NAME(bgv::MatMultValBenchmarkDescription)
public:
...
{
public:
    HEBERROR_DECLARE_CLASS_NAME(bgv::MatMultValBenchmark)
...
private:
    static constexpr std::uint64_t ParametersCount =
        2; // number of parameters for this operation
    static constexpr std::uint64_t ResultComponentsCount =
        1; // number of components of result for this operation
    ...
    std::vector<helib::PtxtArray> encodeMatrix(const std::vector<std::vector<std::int64_t>> &data);
    std::vector<helib::PtxtArray> encodeM0(const std::vector<std::vector<std::int64_t>> &data);
    std::vector<helib::PtxtArray> encodeM1(const std::vector<std::vector<std::int64_t>> &data);
