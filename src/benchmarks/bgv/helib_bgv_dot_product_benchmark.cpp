    ...
    hebench::APIBridge::Category category)
{
    ...
    default_workload_params.add<std::uint64_t>(
        DotProductBenchmarkDescription::DefaultCyclotomicPoly, "CyclotomicPoly");
    default_workload_params.add<std::uint64_t>(
    ...
    const hebench::APIBridge::WorkloadParams *p_w_params) const
{
    ...
    std::uint64_t cyclotomic_poly =
        p_w_params->params[DotProductBenchmarkDescription::Index_CyclotomicPoly]
            .u_param;
    ...
    m_w_params(bench_params)
{
    ...
    std::uint64_t cyclotomic_poly = m_w_params.get<std::uint64_t>(
        DotProductBenchmarkDescription::Index_CyclotomicPoly);
