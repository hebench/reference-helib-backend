    ...
    hebench::APIBridge::Category category, hebench::APIBridge::Workload op)
{
    ...
    default_workload_params.add<std::uint64_t>(
        ElementWiseBenchmarkDescription::DefaultPolyModulusDegree,
        "PolyModulusDegree");
    default_workload_params.add<std::uint64_t>(
    ...
    default_workload_params.add<std::uint64_t>(
        ...
        "KeySwitchColumns");
    default_workload_params.add<std::uint64_t>(
        ElementWiseBenchmarkDescription::DefaultPrecision, "Precision");
    ...
    const hebench::APIBridge::WorkloadParams *p_w_params) const
{
    ...
    std::uint64_t poly_modulus_degree =
        p_w_params
            ->params[ElementWiseBenchmarkDescription::Index_PolyModulusDegree]
            .u_param;
    ...
    std::uint64_t precision =
        p_w_params->params[ElementWiseBenchmarkDescription::Index_Precision]
            .u_param;
    ...
    m_w_params(bench_params)
{
    ...
    std::uint64_t precision = m_w_params.get<std::uint64_t>(
        ElementWiseBenchmarkDescription::Index_Precision);
